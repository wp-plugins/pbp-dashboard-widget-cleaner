    ...
    $(function() {
        $.fn.dbcs = function(options) {
            ...
            $(options.button).click(function() {  
                ...
                tb_show('Upload a logo', 'media-upload.php?referer=dbcs&type=image&TB_iframe=true&post_id=0', false);
        ...
        // Usage
        $('.upload').dbcs(); // Use as default option.
    });
}(jQuery));
